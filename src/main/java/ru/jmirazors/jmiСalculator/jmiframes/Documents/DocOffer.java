...
public final class DocOffer extends javax.swing.JInternalFrame implements DocumentImpl {
     ...
     */
    JToolBar tb;
    JButton dockButton = new JButton("Док. реализация|");     
    
    String frameTitle = "Реализация товаров";
    SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy HH:mm");
    public static ArrayList<OfferProduct> products = new ArrayList<>();
...
//                        Float.parseFloat(jLabel10.getText())*Float.parseFloat(jFormattedTextField1.getText())/100));
    ...
    public void docInit() {
        docOffer.setDocuments(documentDAO.getDocumentType(3L));
        docOffer.setOrganization(docOffer.getSessionOrganization());        
        docOffer.setUsr(docOffer.getSessionUser());
        docOffer.setDepartment(docOffer.getSessionUser().getDepartment());
    ...
    public void repaintDocument() {
        ...
        jTextField1.setText(docOffer.getDepartment().getName());                                  // Подразделение
        jLabel6.setText(MainFrame.sessionParams.getParam().getOkv().getRus());                    // Валюта
        jLabel26.setText(MainFrame.sessionParams.getParam().getOkv().getRus());                   // Валюта
        jLabel16.setText(MainFrame.sessionParams.getParam().getOkv().getRus());                   // Валюта  
        jLabel28.setText(docOffer.getOrganization().getName());                                   // Организация
    ...
    private void initComponents() {
        ...
        jLabel27.setText("Подразделение");
...
//            } 
    ...
    private void jTextField1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField1MouseClicked
        // Подразделение
          DepartmentSelectDialog sdd = new DepartmentSelectDialog(null, true, docOffer);
          sdd.setLocationRelativeTo(this);
          sdd.setVisible(true);
          jTextField1.setText(docOffer.getDepartment().getName());                  
