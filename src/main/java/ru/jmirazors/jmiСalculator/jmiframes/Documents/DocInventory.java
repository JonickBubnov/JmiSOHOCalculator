...
import ru.jmirazors.jmiСalculator.jmiframes.ProductToInventoryDialog;
...
public final class DocInventory extends javax.swing.JInternalFrame implements DocumentImpl{
     ...
     */
    JToolBar tb;
    JButton dockButton = new JButton("Док. инвентаризация|");    
    
    String frameTitle = "Инвентаризация товаров";
    SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy HH:mm");
    public static ArrayList<InventoryProduct> products = new ArrayList<>();
    ...
    public void docInit() {
        ...
        docInventory.setDepartment(docInventory.getSessionUser().getDepartment());
    ...
    public void repaintDocument() {
        ...
        jTextField1.setText(docInventory.getDepartment().getName());
...
//        recalculateDocument();
          DepartmentSelectDialog sdd = new DepartmentSelectDialog(null, true, docInventory);
