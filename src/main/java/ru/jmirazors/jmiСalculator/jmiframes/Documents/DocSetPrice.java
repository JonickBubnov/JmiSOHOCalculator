...
import ru.jmirazors.jmiСalculator.jmiframes.ProductToSetPriceDialog;
...
public final class DocSetPrice extends javax.swing.JInternalFrame implements DocumentImpl {
    ...
    public static ArrayList<SetPriceProduct> products = new ArrayList<>();
    ...
    public void docInit() {
        ...
        docSetPrice.setOrganization(docSetPrice.getSessionOrganization());        
        docSetPrice.setUsr(docSetPrice.getSessionUser());
        docSetPrice.setDepartment(docSetPrice.getSessionUser().getDepartment());
    ...
    public void repaintDocument() {
        ...
        jTextField2.setText(docSetPrice.getDepartment().getName());
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Подразделение");
...
//            } 
    ...
    private void jTextField2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField2MouseClicked
        // TODO add your handling code here:
          DepartmentSelectDialog sdd = new DepartmentSelectDialog(null, true, docSetPrice);
          sdd.setLocationRelativeTo(this);
          sdd.setVisible(true);
          jTextField1.setText(docSetPrice.getDepartment().getName());         
