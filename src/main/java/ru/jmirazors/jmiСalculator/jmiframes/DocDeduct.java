...
public final class DocDeduct extends javax.swing.JInternalFrame implements DocumentImpl {
     ...
     */
    JToolBar tb;
    JButton dockButton = new JButton("Док. спис. тов.");     
    
    String frameTitle = "Списание товаров";
    SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy HH:mm");
    static ArrayList<DeductProduct> products = new ArrayList<>();
    ...
    public void docInit() {
        ...
        docDeduct.setOrganization(MainFrame.sessionParams.getOrganization());        
        docDeduct.setUsr(MainFrame.sessionParams.getUser());
    ...
    public void repaintDocument() {
        ...
        jTextField2.setText(docDeduct.getOrganization().getName());
