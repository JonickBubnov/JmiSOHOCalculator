 ...
 * @author Jonick
 */
public class ContragentSelectNameDialog extends javax.swing.JDialog {

    /**
     * Creates new form ContragentSelectDialog
     */
    ...
    StringBuffer contrName;
    
    public ContragentSelectNameDialog(java.awt.Frame parent, boolean modal, StringBuffer name) {
        super(parent, modal);
    ...
    void getContragents(){
        try {
            ...
            while (it.hasNext()) {
                contragent = (Contragent)it.next();
                tableModel.addRow(new Object[]{contragent.getId(), contragent.getName()});
            }
        } catch (Exception ex) {
            Logger.getLogger(ContragentSelectNameDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            try {
                contragent = new ContragentDAO().getById(id);
                contrName.delete(0, contrName.length());
                contrName.append(contragent.getName());
                dispose();
            } catch (Exception ex) {
                Logger.getLogger(ContragentSelectNameDialog.class.getName()).log(Level.SEVERE, null, ex);
            }
