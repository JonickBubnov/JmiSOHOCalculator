 ...
 * @author User
 */
public class ContragentSelectDialog extends javax.swing.JDialog {
    ...
    public ContragentSelectDialog(java.awt.Frame parent, boolean modal, Document doc) {
        super(parent, modal);
