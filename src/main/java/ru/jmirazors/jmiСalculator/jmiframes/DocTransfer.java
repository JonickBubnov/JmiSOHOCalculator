...
import ru.jmirazors.jmiСalculator.DAO.UtilDAO;
...
public class DocTransfer extends javax.swing.JInternalFrame implements DocumentImpl{
     ...
     */
    JToolBar tb;
    JButton dockButton = new JButton("Док. перем. |");     
    
    String frameTitle = "Перемещение товаров";
    SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy HH:mm");
    static ArrayList<TransferProduct> products = new ArrayList<>();
