 ...
 * @author User
 */
public class ProductToCartCountDialog extends javax.swing.JDialog {

    /**
     * Creates new form ProductToCartCountDialog
     */
    DocumentProduct documentProduct;
    Product product;
    
    public ProductToCartCountDialog(java.awt.Frame parent, boolean modal, Product product, String count, String price, String doc) {
        super(parent, modal);
        ...
        switch (doc){
            case "invoice":
                documentProduct = new InvoiceProduct();
                break;
            case "arrival":
                documentProduct = new ArrivalProduct();
                break;
            case "offer":
                documentProduct = new OfferProduct();
                break;
            case "transfer":
                documentProduct = new TransferProduct();
                break;
            case "deduct":
                documentProduct = new DeductProduct();
                break;
            case "receipt":
                documentProduct = new ReceiptProduct();
                break;
            case "inventory":
                documentProduct = new InventoryProduct();
                break;
        }
    }
    ...
    private void jFormattedTextField2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFormattedTextField2KeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {            
            ...
            ProductToCartDialog.cartProduct = documentProduct;
            dispose();
        }
