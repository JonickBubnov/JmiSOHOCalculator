...
public final class DocArrival extends javax.swing.JInternalFrame implements DocumentImpl{

    /**
     * Creates new form DocArrival
     */
    JToolBar tb;
    JButton dockButton = new JButton("Док. пост.|");     
    
    String frameTitle = "Поступление товаров";
    SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy HH:mm");
    static ArrayList<ArrivalProduct> products = new ArrayList<>();
    ...
    public void docInit() {
        ...
        docArrival.setOrganization(MainFrame.sessionParams.getOrganization());        
        docArrival.setUsr(MainFrame.sessionParams.getUser());
    ...
    public void repaintDocument() {
        ...
        jTextField1.setText(docArrival.getOrganization().getName());
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jLabel24, javax.swing.GroupLayout.PREFERRED_SIZE, 424, javax.swing.GroupLayout.PREFERRED_SIZE))))
