 ...
 * @author User
 */
public class SelectContragentDialog extends javax.swing.JDialog {

    /**
     * Creates new form SelectContragentDialog
     */
    ...
    HashMap<String, String> selContragents;      
    
    public SelectContragentDialog(java.awt.Frame parent, boolean modal, HashMap<String, String> contragents) {
        super(parent, modal);
        selContragents = contragents;
    ...
    void getContragents() {
        ...
        List<Contragent> contragents = new ContragentDAO().list();
        for (Contragent contragent : contragents) {                        
            tableModel.addRow(new Object[] {isSelected(contragent)?"1":"0", contragent.getName()});
        }        
    }
    boolean isSelected(Contragent contragent) {
        if (selContragents.get(contragent.getName()) == "1")
            return true;
        return false;
    }     
    void selectAll() {
        ...
        for (String key : selContragents.keySet()) {
            selContragents.put(key, "1");
        }
        }
    }    
    String togleValue() {        
